...
/* SPI-NAND flash Manufacturer ID Codes */
#define SPI_NAND_MFR_GD		0xc8
#define SPI_NAND_MFR_WB		0xef
#define SPI_NAND_MFR_ATO	0x9b
#define SPI_NAND_MFR_DOSILISION	0xe5
...
extern struct nand_flash_dev nvt_nand_ids[];
