...
#define CONFIG_N69004_A32_ANDROID_OREO 	1
...
#define CONFIG_SYS_LOAD_ADDR		0x30000000 /* default load address */
...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	...
	"memstr=mem=606M@38M mem=745M@2048M\0" \
	"memstr_3g=mem=606M@38M mem=1024M@1024M mem=745M@2048M\0" \
	"cpus=4\0" \
	"usb_port=0\0" \
	"usb=/dev/mmcblk0p17\0" \
	"verify=y\0" \
	"quiet=y\0" \
        "selinux=y\0" \
        "no_secos=y\0" \
	"kparam_addon=no_console_suspend androidboot.hardware=nt72673_a32"
