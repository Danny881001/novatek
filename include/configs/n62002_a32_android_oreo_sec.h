...
#ifndef _N62002_A32_ANDROID_OREO_SEC_H
#define _N62002_A32_ANDROID_OREO_SEC_H

#include <linux/stringify.h>

#define CONFIG_N62002_A32_ANDROID_OREO_SEC 	1
...
#define CONFIG_SYS_FWUPDATE_BUF         0x7800000//set 120MB as firmware update buffer
...
#define CONFIG_SIGN_TOOL_DIR	n62002_a32_android_oreo_sec
...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	"kernel_loadaddr=0x25FFFC0\0" \
	"memstr=mem=573M@38M mem=196M@828M mem=734M@2048M mem=68M@3000M\0" \
	"memstr_3g=mem=1597M@38M mem=930M@1852M mem=68M@3000M\0" \
	"cpus=4\0" \
	"usb_port=0\0" \
	"usb="USB_ENV \
	"verify=y\0" \
	"quiet=y\0" \
	"selinux=n\0" \
	"kparam_addon=no_console_suspend androidboot.hardware=n00010_a32"
	
#define CONFIG_BOOTCOMMAND                      "reboot"
#define CONFIG_BOOTARGS 			""

/* #define NVT_EBURNER_IMG_FNAME          "TargetHis/His72673Upgrade.img" */
