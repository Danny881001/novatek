...
#ifndef _NT72172_A32_TK_ANDROID_OPERA_H
#define _NT72172_A32_TK_ANDROID_OPERA_H

#include <linux/stringify.h>

#define CONFIG_TK_172_A32_ANDROID_OPERA 	1
...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	"kernel_loadaddr=0x43FFFC0\0" \
	"memstr=mem=667M@28M mem=413M@2048M\0" \
	"cpus=4\0" \
	"usb_port=0\0" \
	"usb=/dev/mmcblk0p7\0" \
	"verify=y\0" \
	"quiet=y\0" \
        "selinux=y\0" \
	"kparam_addon=no_console_suspend androidboot.hardware=nt72566_a32_tk"
