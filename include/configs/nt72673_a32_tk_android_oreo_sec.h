...
#ifndef _NT72673_A32_TK_ANDROID_OREO_SEC_H
#define _NT72673_A32_TK_ANDROID_OREO_SEC_H

#include <linux/stringify.h>

#define CONFIG_TK_673_A32_ANDROID_OREO_SEC 	1
...
#define CONFIG_SIGN_TOOL_DIR            nt72673_a32_tk_android_oreo_sec

#define CONFIG_SYS_BOOTM_LEN 		(16 << 20)

#define CONFIG_EXTRA_ENV_SETTINGS       \
	"kernel_loadaddr=0x25FFFC0\0" \
	"memstr=mem=527M@38M mem=685M@2048M\0" \
	"cpus=4\0" \
	"usb_port=0\0" \
	"usb="USB_ENV \
	"verify=y\0" \
