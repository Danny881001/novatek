...
#ifndef _NT72673_A32_EMMC_CHINA_DRM_H
#define _NT72673_A32_EMMC_CHINA_DRM_H

#include <linux/stringify.h>

#define CONFIG_EVB_673_A32_EMMC_CHINA_DRM 	1
...
#define CONFIG_SIGN_TOOL_DIR            nt72673_a32_emmc_china_drm

#define CONFIG_NFSK 		1
...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	...
	"memstr=mem=605M@38M mem=273M@2048M\0" \
	"cpus=4\0" \
	"usb_port=0\0" \
	"usb=/dev/mmcblk0p7\0" \
	"verify=y\0" \
	"quiet=n\0" \
        "selinux=n\0" \
        "serialno=nt72172\0" \
	"kparam_addon=no_console_suspend"
