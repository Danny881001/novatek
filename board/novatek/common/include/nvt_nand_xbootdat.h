 ...
 *
 */
#ifndef __NVT_NAND_XBOOT_DAT_H__
#define __NVT_NAND_XBOOT_DAT_H__
...
typedef enum {
	...
	XDAT_HELP_ERASE,
	XDAT_HELP_MAX
} NVT_NAND_XBOOTDAT_HELP_TYPE;

typedef struct _nvt_nand_xbootdat_info {
	char *xdat_name;
	int (*xdathelp)(struct _nvt_nand_xbootdat_info *this, NVT_NAND_XBOOTDAT_HELP_TYPE help_type);
	int (*xdatdump)(struct _nvt_nand_xbootdat_info *this, int argc, char* const argv[]);
	int (*xdatsave)(struct _nvt_nand_xbootdat_info *this, int argc, char* const argv[]);
	int (*xdaterase)(struct _nvt_nand_xbootdat_info *this, int argc, char* const argv[]);
	unsigned int start_block;//
	unsigned int size;//count in block
} nvt_nand_xbootdat_info;
...
#if defined(CONFIG_ARCH_NT72172_A32) || defined(CONFIG_ARCH_NT72172_A64)    //172 use old parameters
