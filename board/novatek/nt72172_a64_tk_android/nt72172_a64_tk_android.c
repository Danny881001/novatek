...
void nt72172_a64_tk_android_burn_image(void)
{
	int ret;
	u32 reg_val, tmp_val;
	char cmd[128] = {0};
	...
	run_command("emark_format_db cache", 0);
	run_command("emark_format_db tvos", 0);
	run_command("emark_format_db apdat", 0);
	run_command("emark_format_db data", 0);
...
{
	nt72172_a64_tk_android_burn_image();
}
