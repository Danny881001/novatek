...
#define REG_CLK_GEN_IC_VER              (REG_CLK_GEN_BASE + 0x104)

/* STBC */
#define REG_STBC_BASE                   (0xfc040000)
#define REG_STBC_IPC                    (0xfc040000)
#define REG_STBC_00                     (0xfc040200)
#define REG_STBC_04                     (0xfc040204)
#define REG_STBC_08                     (0xfc040208)
#define REG_STBC_SWITCH                 (0xfc040250)
#define REG_STBC_1C                     (0xfc04021c)
#define REG_STBC_BOOTSTRAP_RAW          (0xfc04023c)	/* Raw value */
#define REG_STBC_BOOTSTRAP              (0xfc040700)	/* Written by STBC */
#define STBC_1C_NFC_RST                 (1 << 25)

/* GPIO */
#define REG_GP_BASE                    (0xfd0f0000)

/* GPB */
#define REG_GPB_SET_CLR                 (REG_GP_BASE + 0x200)
#define REG_GPB_SET_EN                  (REG_GP_BASE + 0x204)
#define REG_GPB_IODCR                   (REG_GP_BASE + 0x208)
#define REG_GPB_MUX_SEL0                (REG_GP_BASE + 0x220)
#define REG_GPB_MUX_SEL1                (REG_GP_BASE + 0x224)
#define REG_GPB_MUX_SEL2                (REG_GP_BASE + 0x228)
#define GPB_NAND_MASK                   (0x1FFFC)

/* GPC */
#define REG_GPC_SET_CLR                 (REG_GP_BASE + 0x80)
#define REG_GPC_SET_EN                  (REG_GP_BASE + 0x84)
#define REG_GPC_IODCR                   (REG_GP_BASE + 0x88)
#define REG_GPC_MUX_SEL0                (REG_GP_BASE + 0xac)

/* GPD */
#define REG_GPD_SET_CLR                 (REG_GP_BASE + 0xc0)
#define REG_GPD_SET_EN                  (REG_GP_BASE + 0xc4)
#define REG_GPD_IODCR                   (REG_GP_BASE + 0xc8)
#define REG_GPD_MUX_SEL0                (REG_GP_BASE + 0xe0)
#define REG_GPD_MUX_SEL1                (REG_GP_BASE + 0xe4)

/* AHB */
#define REG_AHB_BASE                    (0xFC0F0000)
#define REG_AHB_TIMEOUT0                (0xFC0F0088)
#define REG_AHB_TIMEOUT1                (0xFC0F00CC)

/* NFC registers */
#define REG_NFC_BASE                    (0xfc048000)
#define REG_NFC_BASE_ARM                (0xfc3e0000)
#define REG_NFC_BASE_ARM_OFFSET         (REG_NFC_BASE_ARM - REG_NFC_BASE)
...
#define REG_NFC_BLANK_CNT0      (REG_NFC_BASE + 0x1CC)
#define REG_NFC_BLANK_CNT1      (REG_NFC_BASE + 0x1D0)
...
#define NFC_CFG1_ECC_BCH8_32                ((0x1 << 21) | (0x0 << 16))
#define NFC_CFG1_ECC_BCH8_56                ((0x1 << 21) | (0x1 << 16))

#define NFC_CFG1_ECC_RS_NEW                 (0x1 << 16)
#define NFC_CFG1_ECC_BCH_NEW                (0x1 << 21)
...
#define NFC_SFTRST_BCH_DECODE                     (0x1 << 2)
