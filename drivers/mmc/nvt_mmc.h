...
#ifndef __NT72670B_MMC_HOST_H
#define __NT72670B_MMC_HOST_H

//#include <asm/arch/hardware.h>
#include <asm/types.h>
#include <asm/arch/nvt_stbc_regs.h>
#include <asm/arch/nvt_nfc_regs.h>
#include <nvt_stbc.h>

#if defined(CONFIG_NVT_COMMON_EMMC) || defined(CONFIG_NVT_COMMON_EMMC_LEGACY)
...
#define REG_NFC_SYS_CTRL                        (*(volatile u32*)(REG_NFC_BASE+0x5c))
...
/* eMMC driving Setup for 670 later*/
#define REG_EMMC_IO_CTL_BASE 0xFC040000
#define EMMC_IO_DRV_D0			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD60))
#define EMMC_IO_DRV_D1			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD64))
#define EMMC_IO_DRV_D2			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD68))
#define EMMC_IO_DRV_D3			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD6C))
#define EMMC_IO_DRV_D4			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD70))
#define EMMC_IO_DRV_D5			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD74))
#define EMMC_IO_DRV_D6			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD78))
#define EMMC_IO_DRV_D7			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD7C))
#define EMMC_IO_DRV_CLK			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD80))
#define EMMC_IO_DRV_CMD			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD84))
#define EMMC_IO_DRV_DS			(*(volatile u32*)(REG_EMMC_IO_CTL_BASE+0xD88))
#define SET_EMMC_IO_DRV(IO_NAME,VAL)	IO_NAME = ((IO_NAME & (~0x3FF)) | (VAL & 0x3FF ))
#if defined(CONFIG_EMMC_WRITE_RELIABILITY_TEST)
//GPG3
#define SET_EMMC_POWER_DOWN_FUN	(*(volatile u32*)(0xFC04043C))
#define SET_EMMC_POWER_DOWN_DIR	(*(volatile u32*)(0xFC040430))
#define SET_EMMC_POWER_DOWN_PUL	(*(volatile u32*)(0xFC040424))
#endif
#endif
